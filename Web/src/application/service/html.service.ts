...
export class HtmlService {
  public static beautifyTable(html: string): string {
    ...
    table.addClass("w-fill table-auto w-fit rounded-md shadow-lg border-separate border-spacing-y-1");
    ...
    const filterScript = fs.readFileSync('./resource/filter-beautified-table.js', 'utf8')
