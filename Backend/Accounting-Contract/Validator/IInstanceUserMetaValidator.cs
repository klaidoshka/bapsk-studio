...
public interface IInstanceUserMetaValidator
{
    ...
    public Task<Validation> ValidateInstanceUserMetaCreateRequestAsync(
    ...
    /// <param name="request">Request to process</param>
    /// <returns>Validation result</returns>
    public Task<Validation> ValidateInstanceUserMetaDeleteRequestAsync(
    ...
    /// <param name="request">Request to process</param>
    /// <returns>Validation result</returns>
    public Task<Validation> ValidateInstanceUserMetaGetRequestAsync(
    ...
    /// <param name="request">Request to process</param>
    /// <returns>Validation result</returns>
    public Task<Validation> ValidateInstanceUserMetaGetByInstanceRequestAsync(
