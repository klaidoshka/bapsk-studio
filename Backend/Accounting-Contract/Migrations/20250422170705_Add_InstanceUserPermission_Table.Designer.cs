...
namespace Accounting.Contract.Migrations
{
    ...
    [Migration("20250422170705_Add_InstanceUserPermission_Table")]
    partial class Add_InstanceUserPermission_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounting.Contract.Entity.InstanceUserPermission", b =>
                {
                    b.Property<int>("InstanceUserMetaId")
                        .HasColumnType("int");

                    b.Property<string>("Permission")
                        .HasColumnType("varchar(255)");

                    b.HasKey("InstanceUserMetaId", "Permission");
            ...
            modelBuilder.Entity("DataTypeFieldReportTemplate", b =>
                {
                    b.Property<int>("FieldsId")
                        .HasColumnType("int");

                    b.Property<int>("ReportTemplatesId")
                        .HasColumnType("int");

                    b.HasKey("FieldsId", "ReportTemplatesId");

                    b.HasIndex("ReportTemplatesId");
            ...
            modelBuilder.Entity("Accounting.Contract.Entity.InstanceUserPermission", b =>
                {
                    b.HasOne("Accounting.Contract.Entity.InstanceUserMeta", "InstanceUserMeta")
                        .WithMany("Permissions")
                        .HasForeignKey("InstanceUserMetaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InstanceUserMeta");
                });
            ...
            modelBuilder.Entity("DataTypeFieldReportTemplate", b =>
                {
                    b.HasOne("Accounting.Contract.Entity.DataTypeField", null)
                        .WithMany()
                        .HasForeignKey("FieldsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Accounting.Contract.Entity.ReportTemplate", null)
                        .WithMany()
                        .HasForeignKey("ReportTemplatesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
